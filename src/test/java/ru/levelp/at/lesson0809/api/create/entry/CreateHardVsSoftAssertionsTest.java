...
class CreateHardVsSoftAssertionsTest {
    ...
    @Test
    void createPersonSoftAssertionTest() {
        var faker = new Faker();
        ...
        SoftAssertions.assertSoftly(softly -> {
            ...
            softly.assertThat(responseBody.getData().getEmail()).isEqualTo(requestBody.getEmail() + " 1");
    ...
    @Test
    void createPersonHardAssertionTest() {
        var faker = new Faker();
        var email = faker.internet().emailAddress();
        var firstName = faker.name().firstName();
        ...
        // Assumptions.assumeTrue(false, () -> "aksdjanvjds");
        //        Assumptions.assumingThat(true,
        //            () -> assertThat(responseBody.getData().getIdentity().getFirstName())
        //                .isEqualTo(requestBody.getEmail() + " 1")
        //        );

        assertThat(responseBody.getData().getId()).isNotBlank();
        assertThat(responseBody.getData().getEmail()).isEqualTo(requestBody.getEmail() + " 1");
        assertThat(responseBody.getData().getRole()).isEqualTo(requestBody.getRole());
        assertThat(responseBody.getData().getIdentity().getDateOfBirth() + " ")
            .isEqualTo(requestBody.getIdentityData().getDateOfBirth());
    }
}
